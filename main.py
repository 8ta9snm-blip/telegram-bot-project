...
# Bot configuration
TOKEN = os.getenv("TOKEN", "7677905673:AAFYB0xbJfE3NRpTUIqz2AJqhjRg3Dr8UJE")
...
1️⃣ إذا كان عندك حساب Sugo مضاف مسبقاً على جهازك، لازم تعملي تقديم من جهاز آخر. وبعد القبول (عادةً خلال 6 ساعات) بتقدري ترجعي تفتحيها على موبايلك الأساسي بدون أي مشاكل.
...
SUGO_FINAL_TEXT = "هذا المعرف الذي ستبعثوا عليه معلومات التواصل مثل ما ذكرت بالفيديو @Blueberrykity"

# --- SOMATCH ---
SOMATCH_CAPTION_1 = "🎥 خطوة 1 — طريقة إنشاء الحساب بالـ Somatch"
SOMATCH_TEXT_1_1 = """💡 طرق حل بعض المشاكل:

1️⃣ إذا كان عندك حساب Somatch مضاف مسبقاً على جهازك، لازم تعملي تقديم من جهاز آخر. وبعد القبول (عادةً خلال 6 ساعات) بتقدري ترجعي تفتحيها على موبايلك الأساسي بدون أي مشاكل.
...
SOMATCH_FINAL_TEXT = "هذا المعرف الذي ستبعثوا عليه معلومات التواصل مثل ما ذكرت بالفيديو @Blueberrykity"
